  ...
  return (
    <section id="work" className="max-w-3xl mx-auto px-4 py-24 sm:px-6">
      ...
      <div className="reveal-scroll reveal-scroll-delay-1 border border-primary/10 rounded-xl bg-card/50 p-6 sm:p-8">
        ...
        <p className="mt-1 text-sm text-primary/60">{workExperience.company}</p>
        ...
        <div className="mt-5 space-y-2.5">
          {workExperience.highlights.map((item, i) => (
            <div key={i} className="flex gap-3 text-[12px] leading-relaxed text-muted-foreground/80 terminal-line">
              <span>{item}</span>
            </div>
          ))}
        </div>
